# -*- coding: utf-8 -*-
"""
Created on Mon Nov  9 14:26:06 2020
...
from State.global_state import *
#################### PLOT PRINTER #############################

class PlotPrinter(QWidget):
    ploting_information = pyqtSignal(dict)
    def __init__(self):
        self.datas = []
        super().__init__()
        self.figure = Figure()
        ...
        self.setWindowTitle("Diagramme linéaire")
    ...
    def text(self,info):
        ...
        if info[0] == 1:
            ...
            self.ploting_info["plot info annotation text"] = self.text_list
            self.canvas.draw()
        else:
            dic = {
                 "family": info[1][0],
    ...
    def modification(self,tab):
        ...
        if tab [0] == 1:
            ...
            #Pour un transfert ultérieur
            self.annotation_list = tab
            self.ploting_info["plot info annotation modification"] = self.annotation_list
            self.canvas.draw()
    ...
    def plot(self,information):
        ...
        if information[0] == 1:
            if len(information[1]) == 1:
                ...
                self.ax.set_title(information[2][0]+ "                      |Created whith "+SOFTWARE_NAME)
    ...
    def closeEvent(self,event):
        self.ploting_information.emit(self.ploting_info)
        print("emited-- 1")
        self.helper.close()
