# -*- coding: utf-8 -*-
"""
Created on Sun Nov 22 13:39:18 2020
...
class StackPrinter(QWidget):
    def __init__(self):
        ...
        self.toolbar_button = QPushButton(QIcon("tool.png"),"")
        ...
        self.setWindowTitle("Diagramme à couches")
    ...
    def stackplot(self,information):
        print(information) 
        ...
        if information[0] == 1:
            ...
            if information[4][1] != information[4][2]:     
                if type(is_only_number(self.datas[get_tab_pos(information[4][0])][information[4][1]:information[4][2]-1])) == bool:
                    x = to_number(self.datas[get_tab_pos(information[4][0])][information[4][1]:information[4][2]-1])
                
                elif type(is_only_number(self.datas[get_tab_pos(information[4][0])][information[4][1]:information[4][2]-1])) == tuple:
                    QMessageBox.information(self,self,"Information","La case " +
                                            str(is_only_number(self.datas[information[4][0]][information[4][1]:information[4][2]-1])[1]) + " de la colonne "
            ...
            self.ax.stackplot(x,final_data,labels = information[2][0],colors = information[2][1])
