# -*- coding: utf-8 -*-
"""
Created on Thu Nov 26 15:24:21 2020
...
class BoxPlotPrinter(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Diagramme à moustache")
    ...
    def boxplot(self,information):
        print(information) 
        
        if information[0] == 1:
            for i in range(len(information[1])):
                if information[2][2][i][0] != information[2][2][i][1]:
                    if type(is_only_number(self.datas[information[1][i]][information[2][2][i][0]-1:
                                                                         information[2][2][i][1]])) == bool:
                        
                        self.datas[information[1][i]][information[2][2][i][0]-1:
                                    information[2][2][i][1]-1] = \
                            to_number(self.datas[information[1][i]][information[2][2][i][0]-1:
                                                                         information[2][2][i][1]])
                                
                    elif type(is_only_number(self.datas[information[1][i]][information[2][2][i][0]-1:
                                                                         information[2][2][i][1]])) == tuple:
                        QMessageBox.information(self,"Information","La case " +
                                            str(is_only_number(self.datas[information[1][i]][information[2][2][i][0]-1:
            ...
            for i in range(len(information[1])):
                if information[2][2][i][0] != information[2][2][i][1]:
                    ...
                    final_data.append(self.datas[information[1][i]][information[2][2][i][0]-1:
                                                                         information[2][2][i][1]])
                else:
            ...
            orientation_dict["Horirontal"] = False
            orientation_dict["Vertical"] = True 
            
            notch_dict = dict()
            notch_dict["True"] = True
            notch_dict["False"] = False

            
            self.ax.boxplot(final_data,
                            boxprops = {"color":colors_[0]},
                            capprops = {"color":colors_[0]},
                            whiskerprops = {"color":colors_[0]},
                            flierprops = {"color":colors_[0]},
                            medianprops = {"color":colors_[0]},
                            meanprops = {"color":colors_[0]},
                                           
                            labels = information[2][0],
                            vert = orientation_dict[information[4][0]],
                            notch=notch_dict[information[4][1]])
