...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 13:04:20 2020
...
class BarPrinter(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Diagramme à bandes")
    ...
    def bar(self,information):
        ...
        if information[0] == 1:
            if len(information[1]) == 1:
                ...
                #print(len(self.data_1),"ELVIS KING")
                if width > 0:
                    
                    if information[3][1] == "Horizontal":
                        limits = information[4]
