...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 17 12:44:41 2020
...
from Visualisation_outils.barprinter import *

# Permet de créer de nouvelle fenêtre quand on utilise nouveau

class BarInfoReceiver_1(QWidget):
...
class BarInfoReceiver_2(QWidget):
    send_info = pyqtSignal(list)
    def __init__(self):
        super().__init__()
...
class BarInfoReceiver(QWidget):
    def __init__(self):
        super().__init__()
        
        self.one_list_data_receiver = BarInfoReceiver_1()
        self.double_list_data_receiver = BarInfoReceiver_2()
    ...
    def init_UI(self):
        ...
        self.setWindowTitle("Fenêtre de renseignement du diagramme à bandes")
    ...
    def bar(self,information):
        if information[0] == 1:
            self.bar_printer.bar(information)
            ...
            self.a.bar(information)
            self.a.show()
            
            """
            code = ""
            code =  "a"+str(I)+ " = BarPrinter() \n"
            code = code + "a"+str(I)+".set_datas(self.datas)\n"
            code = code + "a"+str(I)+".bar(information)\n"
