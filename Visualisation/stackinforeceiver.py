# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 19:13:14 2020
...
from Visualisation_outils.stackprinter import *
from Visualisation_outils.stackbuttons import *

class StackInfoReceiver(QWidget):
    def __init__(self):
        super().__init__()
        ...
        # Printer
        self.stack_printer = StackPrinter()
        self.a = StackPrinter()
    ...
    def init_UI(self):
        ...
        self.setWindowTitle("Fenêtre de renseignement du diagramme à couche")
    ...
    def other_manage(self):
        ...
        self.begin_receiver.setRange(1,1000000)
        self.end_receiver.setRange(1,1000000)
    ...
    def stackplot(self,info):
        if info[0] == 1:
            self.stack_printer.stackplot(info)
            self.stack_printer.show()
        elif info[0] == 2:
            info[0] = 1
            self.a.clear()
            self.a.set_datas(self.datas)
            self.a.stackplot(info)
            self.a.show()
            
        
    def set_printer_data(self,data):
        self.datas = data
        self.stack_printer.set_datas(data)
